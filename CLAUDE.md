...
- **策略类型**: 策略, momentum, 动量, mean-reversion, portfolio-optimization, 套利, 打新, 行业轮动, 风格轮动, 因子择时, 金股组合, 拥挤度复合因子, 大小盘风格轮动, 成长价值风格轮动, 事件驱动策略, 概念主题投资, 业绩超预期, 景气度, 均值回归, 多策略叠加, 多任务学习, 光伏行业
- **投资风格**: 价值投资, 成长投资, 主动基金
