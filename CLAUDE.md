...
- **因子投资**: 因子投资, factor-investing, 因子, 量化, 指数增强, ai应用, 量化基本面, 多因子模型, 分析师预期因子, 反转因子, 高频量价因子, 聪明钱因子
- **策略类型**: 策略, momentum, 动量, mean-reversion, portfolio-optimization, 套利, 打新, 行业轮动, 风格轮动, 金股组合, 拥挤度复合因子, 大小盘风格轮动, 成长价值风格轮动, 事件驱动策略, 概念主题投资
- **投资风格**: 价值投资, 成长投资, 主动基金
- **资产配置**: 资产配置, 组合管理, 调仓, 建仓, 股债轮动, 风险平价, black-litterman模型, 均值方差模型
...
- **机器学习**: 机器学习, 集成学习, 深度学习, xgboost模型, 强化学习
- **ESG**: esg
- **政策法规**: 政策法规
