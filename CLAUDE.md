...
- **因子投资**: 因子投资, factor-investing, 因子, 量化, 量化投资, 指数增强, ai应用, 量化基本面, 多因子模型, 分析师预期因子, 反转因子, 高频量价因子, 聪明钱因子, 聪明贝塔, 宏观因子, 行业景气度, 基本面量化, 因子挖掘, 量价因子, 资产定价, 指数增强策略, alpha传导链, 流动性溢价, 估值因子, 低波异象, 市值因子, 因子选股, 动态因子模型, 成长因子, 特质波动率, 因子重构, 港股多因子框架, 盈利因子, 小市值, 因子切割论, 一致预期
- **策略类型**: 策略, momentum, 动量, mean-reversion, portfolio-optimization, 套利, 打新, 行业轮动, 风格轮动, 风格轮动策略, 因子择时, 金股组合, 拥挤度, 因子拥挤度, 拥挤度复合因子, 行业拥挤度, 大小盘风格轮动, 成长价值风格轮动, 事件驱动策略, 概念主题投资, 业绩超预期, 景气度, 均值回归, 多策略叠加, 多任务学习, 光伏行业, 企业生命周期, 供应链动量
- **投资风格**: 价值投资, 成长投资, 主动基金
- **资产配置**: 资产配置, 组合管理, 组合优化, 调仓, 建仓, 股债轮动, 风险平价, 风险预算模型, black-litterman模型, 均值方差模型, fof组合构建, 固收+策略, 全天候策略, 美林时钟, 普林格周期, 货币信用周期
...
- **基本面**: 基本面, 估值, valuation, 宏观, 经济周期, 盈余管理, 规模效应, 财务风险, 财务预测, 动态时间弯曲
- **技术面**: 技术面, 趋势跟踪, 择时, 量价关系, 市场微观结构, k线形态学, bollinger带, 均线系统, 算法交易, 高频因子, 傅里叶变换, 形态识别, 情绪指标
...
- **另类数据**: 另类数据, high-frequency, alternative-data, 机构调研, 文本情感分析, 高频数据
- **行为金融**: 行为金融学, 羊群效应
- **机器学习**: 机器学习, 随机森林, 集成学习, 深度学习, 神经网络, 卷积神经网络, 循环神经网络, 大语言模型, transformer模型, 多模态大语言模型, xgboost模型, 强化学习, 排序学习, ltr, gru网络, 图神经网络, 注意力机制, 主成分分析, 遗传规划, lstm模型, 多智能体系统, lightgbm模型, 多频率因子
- **ESG**: esg
- **政策法规**: 政策法规

### 内容类型 / Content Type

- **来源**: 券商研报, brokerage-report, 公众号, 学术, 华泰金工, 华泰固收-金工, 中金固收, 东北金工, 开源金工, 国泰君安配置团队, 华创金工, 中银量化, 光大金工, 华安金工, 广发金工, 东方证券, 招商定量任瞳团队, 中信建投金工, 申万宏源金工
