...
- **因子投资**: 因子投资, factor-investing, 因子, 量化, 量化投资, 指数增强, ai应用, 量化基本面, 多因子模型, 分析师预期因子, 反转因子, 高频量价因子, 聪明钱因子, 聪明贝塔, 宏观因子, 行业景气度, 基本面量化, 因子挖掘, 量价因子, 资产定价, 指数增强策略, alpha传导链, 流动性溢价, 估值因子, 低波异象, 市值因子, 因子选股, 动态因子模型, 成长因子
