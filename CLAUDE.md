...
- **因子投资**: 因子投资, factor-investing, 因子, 量化, 指数增强, ai应用, 量化基本面, 多因子模型, 分析师预期因子, 反转因子, 高频量价因子, 聪明钱因子, 聪明贝塔, 宏观因子, 行业景气度, 基本面量化, 因子挖掘, 量价因子, 资产定价
...
- **机器学习**: 机器学习, 集成学习, 深度学习, 神经网络, 大语言模型, xgboost模型, 强化学习, 排序学习, ltr, gru网络
- **ESG**: esg
- **政策法规**: 政策法规
