...
> 来源：https://dict.thinktrader.net/nativeApi/question_function.html
...
> **提示**：由于机制限制，同一个session的两次python进程 connect之间必须超过3秒钟
...
参考：[指定session id范围连接交易](完整实例.md#指定session-id范围连接交易)
