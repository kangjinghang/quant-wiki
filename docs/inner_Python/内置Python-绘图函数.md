...
## 二、ContextInfo.draw_text - 在图形上显示文字

在图形上显示文字

**调用方法：** `ContextInfo.draw_text(condition, position, text)`
...
## 三、ContextInfo.draw_number - 在图形上显示数字
...
## 四、ContextInfo.draw_vertline - 在数字1和数字2之间绘垂直线
...
## 五、ContextInfo.draw_icon - 在图形上绘制小图标
